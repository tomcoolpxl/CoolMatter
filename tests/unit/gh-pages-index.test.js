...
describe('GitHub Pages index', () => {
  it('contains the project title and app host framing', () => {
    ...
    expect(html).toContain('Explore hydrogen orbitals as probability landscapes.')
  ...
  it('includes an app mount and a Vite module entry without a source import map', () => {
    ...
    expect(html).toContain('Viewer-first workspace with guided controls and advanced diagnostics tucked away.')
  })
})
